...
class FavouriteAdapter(private val mFavouriteClickCallback: FavouriteAdapterCallbacks?) : RecyclerView.Adapter<FavouriteAdapter.FavouriteViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): FavouriteViewHolder {
        val binding = DataBindingUtil
                .inflate<JokeItemBinding>(LayoutInflater.from(parent.context), R.layout.joke_item,
                        parent, false)
        binding.callback = mFavouriteClickCallback
